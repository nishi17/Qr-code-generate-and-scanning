package com.example.nishi.qrcode_generate_scan;
...
/*implements ZXingScannerView.ResultHandler*//*
 {
    ...
    private void takePicture() {
        ...
        imageUri = FileProvider.getUriForFile(ScanActivity.this, BuildConfig.APPLICATION_ID + ".provider", photo);
...
/*
    ...
    public void handleResult(Result rawResult) {
        ...
        Log.e("kkkk", rawResult.getText()); // Prints scan results
      //  Log.e("uuuu", rawResult.getBarcodeFormat().getName()); // Prints the scan format (qrcode, pdf417 etc.)
...
public class ScanActivity extends Activity implements ZBarScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        String sourceString = "<i> <font color='#EE0000'>" + "  " +rawResult.getContents() + " </font> </i> " + " Prints the scan "+"\n"+ "format " + "<b>" + rawResult.getBarcodeFormat().getName()+ "</b> " ;
        MainActivity.tvresult.setText(/*(rawResult.getContents() + " Prints the scan format" + rawResult.getBarcodeFormat().getName()*/
